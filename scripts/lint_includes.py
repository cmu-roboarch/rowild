...
# Kasraa (02/18/2022): Python2 --> Python3 / Find all .h files under a parent
# path and apply the script to all of them
...
for e in exts:
    print(f'Extension: {e}')
    for src in list(Path(sys.argv[1]).glob('**/*'+e)):
        if isDontCareFile(src): continue
